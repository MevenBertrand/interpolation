...
Instance sem_typing_term : HasSemTyping context type term := sem_has_type.

Ltac fold_sem_typing :=
...
Smpl Add fold_sem_typing : refold.
...
Proof.
  ...
  - split ; [intuition eauto with typing|].
    ...
    1: eapply ren_comp_has_type ; cycle -1 ; eassumption.
    1: eassumption.
    exists v.
    now asimpl ; refold.
